...
It can also be used as Carousel (```items``` prop to make carousel active) displaying multiple components in single view at a time, (e.g. product cards of flipkart/ecommerce). </br>
